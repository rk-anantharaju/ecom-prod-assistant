...
class FlipkartScraper:
    ...
    def get_top_reviews(self, product_url, count=2):
        """Get the top reviews for a given product."""
        ...
        try:
            ...
            try:
                ...
                log.exception(f"Error occurred while closing popup: {e}")
    ...
    def get_top_products(self, query, max_products=1, review_count=2):
        ...
        for item in items:
            try:
                ...
                total_reviews = re.sub(r'[^0-9]', '', total_reviews)
                ...
                log.exception(f"Error occurred while processing item: {e}")
                continue
